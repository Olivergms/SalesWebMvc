...
namespace SalesWebMvc.Data
{
  public class SeedingService
  {
    ...
    public void seed()
    {
      ...
      Seller s2 = new Seller(2, "Maria green", "maria@gmail.com", 2000.0, new DateTime(1979, 3, 26), d2);
      Seller s3 = new Seller(3, "Alex grey", "Alex@gmail.com", 3000.0, new DateTime(1996, 5, 25), d1);
      Seller s4 = new Seller(4, "Martha red", "Martha@gmail.com", 2500.0, new DateTime(1991, 2, 24), d4);
      Seller s5 = new Seller(5, "Donald blue", "Donald@gmail.com", 3500.0, new DateTime(1992, 1, 23), d3);
      Seller s6 = new Seller(6, "Alex pink", "Alex@gmail.com", 1500.0, new DateTime(1995, 10, 22), d2);
